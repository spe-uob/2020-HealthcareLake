...
\item
  ...
  message. \emph{We have chosen HL7 FHIR as it is the
  \href{https://digital.nhs.uk/services/fhir-uk-core}{UK standard for
...
We will be looking at AWS S3\cite{encryption-in-s3}, AWS Redshift\cite{encryption-in-redshift} and AWS KMS for an example of the implementation of encryption of data lakes.
\\\\\textbf{AWS S3}\\
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\linewidth]{images/EcryptionOverview.PNG}	
\end{figure}
...
We will be examining AWS Identity and Access Management\cite{aws-iam}. IAM is a feature of an AWS account offered at no additional charge. 
\\
