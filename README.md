...
In order for you to deploy the Terraform infrastructure, the API module requires the Node.js Lambda to be bundled into a Zip file and uploaded to an S3 bucket. The Terraform code can then reference this script when deploying the function with API Gateway.
